...
const features = [
  ...
  },
  {
    icon: Award,
    title: 'Best Prices',
    description: 'Competitive pricing with flexible financing options to suit your budget.'
  },
  {
    icon: Headphones,
    title: '24/7 Support',
  ...
  },
  {
    icon: Zap,
    title: 'Fast Delivery',
    description: 'Quick and secure delivery to your doorstep anywhere in the country.'
  }
];
  ...
  return (
    <section className="py-20 bg-slate-50">
      <div className="container mx-auto px-4">
        ...
        >
          <span className="text-blue-600 text-sm uppercase tracking-wider mb-2 block">Why Choose Us</span>
          <h2 className="text-4xl md:text-5xl mb-4">Your Trusted Car Partner</h2>
